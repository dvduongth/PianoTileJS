var GuiEndBattle = BaseGUI.extend({
    ...
    createLabelTime: function () {
        //notice text
        this._lbLabelTime = Utility.getLabel(res.FONT_FUTURA_CONDENSED, 72,Utility.getColorByName("teal"));
    ...
    stopAllChildActions: function () {
        this._sprProgress.stopAllActions();
        this._lbLabelTime.stopAllActions();
    },
    /**
     * hide gui
     * */
